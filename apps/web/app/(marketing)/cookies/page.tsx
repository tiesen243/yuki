    ...
    <main className="flex-1">
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="prose prose-gray max-w-none">
          <p>
            This Cookie Policy explains how Yuki Fashion (&quot;we&quot;,
          ...
          <p>
            Cookies set by the website owner (in this case, Yuki Fashion) are
          ...
          <Table className="my-6">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>yukifashion.com</TableCell>
          ...
          <p>
            ...
            refuse cookies, please note that some parts of our Services may
          ...
          <p>
            The following links show how to adjust the cookie settings on
          ...
          <p>
            In addition to browser controls, we provide a Cookie Preference
            Center that allows you to manage your cookie preferences on our
            website. You can access our Cookie Preference Center by clicking on
          ...
          <h2 className="mt-8 mb-4 text-xl font-semibold">5. Do Not Track</h2>
          <p>
